#
# Be sure to run `pod lib lint ImageSwapper.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = 'Nice animation for swapping images. In progress.'
  ...
  # s.resource_bundles = {
  #   'ImageSwapper' => ['ImageSwapper/Assets/*.png']
  # }
